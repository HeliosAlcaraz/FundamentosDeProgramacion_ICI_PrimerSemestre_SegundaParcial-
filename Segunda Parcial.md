...
| 3  | 2 | 2<=9 | 5 |  3  | num[2]=5 |     
| 4  | 3 | 3<=9 | 8 |  4  | num[3]=8 |   
| 5  | 4 | 4<=9 |10 |  5  | num[4]=10| 
| 6  | 5 | 5<=9 | 1 |  6  | num[5]=1 | 
| 7  | 6 | 6<=9 |15 |  7  | num[6]=15|
| 8  | 7 | 7<=9 | 9 |  8  | num[7]=9 |
| 9  | 8 | 8<=9 | 6 |  9  | num[8]=6 |
|10  | 9 | 9<=9 | 4 | 10  | num[9]=4 |
|11  |10 | 10<=9| - |  -  |     -    |

| #  | i |  i<9 | n | i++ | dist=num[i]-num[i+1] | dist<0 | d[i]=dist*(-1) | d[i]=dist |  
|--- |-- |----- |-- |---- |--------------------- |------- |--------------- |---------- |
| 1  | 0 | 0<=9 | 1 |  1  |       dist=1-3       |   sí   | d[0]=(-2)*(-1) |     -     |
| 2  | 1 | 1<=9 | 3 |  2  |       dist=3-5       |   sí   | d[1]=(-2)*(-1) |     -     |
| 3  | 2 | 2<=9 | 5 |  3  |       dist=5-8       |   sí   | d[2]=(-3)*(-1) |     -     |     
| 4  | 3 | 3<=9 | 8 |  4  |       dist=8-10      |   sí   | d[3]=(-2)*(-1) |     -     |   
| 5  | 4 | 4<=9 |10 |  5  |       dist=10-1      |   no   |        -       |   d[4]=9  |
| 6  | 5 | 5<=9 | 1 |  6  |       dist=1-15      |   sí   | d[5]=(-14)*(-1)|     -     | 
| 7  | 6 | 6<=9 |15 |  7  |       dist=15-9      |   no   |        -       |   d[6]=6  |
| 8  | 7 | 7<=9 | 9 |  8  |       dist=9-6       |   no   |        -       |   d[7]=3  |
| 9  | 8 | 8<=9 | 6 |  9  |       dist=6-4       |   no   |        -       |   d[8]=2  |
|10  | 9 | 9<=9 | 4 | 10  |           -          |    -   |        -       |     -     |
|11  |10 | 10<=9| - |  -  |           -          |    -   |        -       |     -     |
...
![Asteriscos](https://user-images.githubusercontent.com/113320901/198418337-da2ebbc3-ece0-4ea9-a544-16cbef7316ad.png)
### ANÁLISIS
Datos de entrada: ninguno\
Variables: n\
Datos de salida: 
![Asteriscos](https://user-images.githubusercontent.com/113320901/198418361-4b7e71e5-9d33-45c2-8b69-91fb2f54fadd.png)
### DFD
